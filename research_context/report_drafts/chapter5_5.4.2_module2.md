...
**Notes for Team:**
- Stage 1 official model = **Random Forest** (Decision 025), not the pre-Decision-025 XGBoost selection.
- Stage 2 = **isotonic calibration**, not climate-anomaly residual ML.
- Do not paste numeric alert/tier thresholds into Chapter 5 design text; keep them for Chapter 7 (post-Decision-025: alert 0.140, high 0.350).
- Figure assets: `research_context/report_drafts/diagrams/figure_5_4_module2_architecture.drawio` (+ `.png`).

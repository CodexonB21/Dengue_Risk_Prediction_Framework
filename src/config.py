...
MODULE3_PERSISTENCE_BASELINE_PATH = MODULE3_METRICS_DIR / "persistence_baseline_comparison.csv"
MODULE3_STACKED_PERSISTENCE_PATH = MODULE3_METRICS_DIR / "stacked_persistence_experiment.csv"
MODULE3_HOTSPOT_RANKING_PATH = MODULE3_METRICS_DIR / "hotspot_ranking_evaluation.csv"
MODULE3_RF_TUNING_TRIALS_PATH = MODULE3_METRICS_DIR / "rf_hyperparameter_tuning_trials.csv"
MODULE3_RF_TUNING_COMPARISON_PATH = MODULE3_METRICS_DIR / "rf_hyperparameter_tuning_comparison.csv"
MODULE3_BLENDED_PERSISTENCE_RF_PATH = MODULE3_METRICS_DIR / "blended_persistence_rf_comparison.csv"
MODULE3_BLENDED_PERSISTENCE_RF_WEIGHTS_PATH = MODULE3_METRICS_DIR / "blended_persistence_rf_fold_weights.csv"
MODULE3_BLENDED_PERSISTENCE_RF_FOLD_BREAKDOWN_PATH = MODULE3_METRICS_DIR / "blended_persistence_rf_fold_breakdown.csv"
MODULE3_BLENDED_PERSISTENCE_RF_BOOTSTRAP_PATH = MODULE3_METRICS_DIR / "blended_persistence_rf_bootstrap_ci.csv"
MODULE3_BLENDED_PERSISTENCE_RF_REPWEEKS_PATH = MODULE3_METRICS_DIR / "blended_persistence_rf_representative_weeks.csv"
MODULE3_ISOTONIC_CALIBRATION_PATH = MODULE3_METRICS_DIR / "isotonic_calibration_comparison.csv"
MODULE3_ISOTONIC_CALIBRATION_BOOTSTRAP_PATH = MODULE3_METRICS_DIR / "isotonic_calibration_bootstrap_ci.csv"
MODULE3_ISOTONIC_CALIBRATION_DECILE_PATH = MODULE3_METRICS_DIR / "isotonic_calibration_decile_bias.csv"
MODULE3_RELATIVE_RESIDUAL_COMPARISON_PATH = MODULE3_METRICS_DIR / "relative_residual_comparison.csv"
MODULE3_RELATIVE_RESIDUAL_BOOTSTRAP_PATH = MODULE3_METRICS_DIR / "relative_residual_bootstrap_ci.csv"
